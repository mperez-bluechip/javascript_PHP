...
<form id="myform" name="theform" class="group" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
		...
		<ol>
			<li>
				...
				<input type="text" name="myname" id="myname" title="Please enter your name" autofocus placeholder="Last, First" value="<?php if(isset($myname)) : echo $myname; endif; ?>" />
			...
			<li>
				...
				<ol>
					<li>
						...
						<?php if((isset($favoritemusic)) && (in_array("rock", $favoritemusic))): echo "checked";    endif;?>/>
						<label for="rockitem">Rock</label>
					</li>
					<li>
						<input type="checkbox" name="favoritemusic[]" value="classical" id="classicalitem"
<?php if((isset($favoritemusic)) && (in_array("classical", $favoritemusic))): echo "checked";    endif;?>
						/>
						<label for="classicalitem">Classical</label>
					</li>
					<li>
						<input type="checkbox" name="favoritemusic[]" value="reggaeton" id="reggaetonitem"
						<?php if((isset($favoritemusic)) && (in_array("reggaeton", $favoritemusic))): echo "checked";    endif;?>
						/>
			...
			<li>
				...
				<select name="reference" id="reference">
					...
					<option value="friend"
					<?php if((isset($reference)) && ($reference === "friend")) : echo "selected"; endif; ?>>A friend</option>
					<option value="facebook"
					<?php if((isset($reference)) && ($reference === "facebook")) : echo "selected"; endif; ?>>Facebook</option>>Facebook</option>
					<option value="twitter"
					<?php if((isset($reference)) && ($reference === "twitter")) : echo "selected"; endif; ?>>Twitter</option>>Twitter</option>
				</select>
			</li>
			<li>
			...
			<li>
				...
				<textarea name="mycomments" id="mycomments">
					<?php if(isset($mycomments)) : echo $mycomments; endif;?>
				</textarea>
			</li>
		</ol>
